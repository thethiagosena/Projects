...
extension Color {
	...
	static let tabBarBackground = LinearGradient(gradient: Gradient(colors: [Color("Tab Bar Background 1").opacity(0.95), Color("Tab Bar Background 2").opacity(0.95)]), startPoint: .top, endPoint: .bottom)
