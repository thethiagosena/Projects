...
// To call data according to this options
enum ForecastPeriod {
	case hourly, daily
}

// To call icons a according to the case
enum Weather: String {
	case clear = "Clear"
	case cloudy = "Cloudy"
	case rainy = "Mid Rain"
...
// Data Basae
extension Forecast{
	static let hour: TimeInterval = 60 * 60 //60 sec * 60 min
	static let day: TimeInterval = 60 * 60 * 24 //60 sec * 60 min * 24 hours
