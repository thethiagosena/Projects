        ...
        ZStack {
            ...
            VStack (spacing: 20) {
                ...
                VStack(spacing: 0) {
                    ...
                    Text("""
                    It's note how much we give but
                ...
                Spacer()
//                Text(String(format:"%.2f",(buttonOffset/buttonWidth)*100)+"%\n\(Double(imageOffset.width/20))")
                            ...
                            DragGesture()
                                ...
                                .onEnded { _ in
                                    withAnimation(.easeOut(duration: 0.4)){
                                            if buttonOffset > buttonWidth*0.8{
